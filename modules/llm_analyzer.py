...
Когда выбираешь какую версию из группы повторов оставить:
- Оставляй ту, которая является полным самостоятельным высказыванием
- Если финальная попытка начинается с середины фразы (например "нарисуем карточку"
  вместо "давайте нарисуем карточку") — оставь более полную предыдущую версию
- Если ни одна версия не является полной — оставь последнюю (обычно самая чёткая)
...
- Сегменты, удаление которых оставит соседний сегмент незавершённым
