...
Лимит итогового видео: {max_min:.0f} мин ({max_sec:.0f}с)
...
Если суммарная длительность keep=true сегментов НЕ превышает {max_sec:.0f}с —
оставь всё как есть (keep=true, score по важности). Удалять ничего не нужно.

Если суммарная длительность ПРЕВЫШАЕТ {max_sec:.0f}с — удаляй наименее важные пока не уложишься:
