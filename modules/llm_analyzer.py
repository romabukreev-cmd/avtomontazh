...
2. ФАЛЬСТАРТ / СМЫСЛОВОЙ ПОВТОР
   Автор может повторить одну и ту же мысль несколько раз — сразу после или
   через несколько сегментов, дословно или другими словами. Сравнивай СМЫСЛ,
   а не слова. Одна идея в разных формулировках — это повтор.

   Алгоритм для каждого сегмента:
   1. Сформулируй главную мысль сегмента в 5–7 словах.
   2. Проверь предыдущие 5–10 сегментов: была ли эта мысль уже сказана?
   3. Если да — оставь только наиболее полную и чёткую версию, остальные убирай.

   Исключение: если автор возвращается к теме чтобы УГЛУБИТЬ или ДОБАВИТЬ новое —
   это развитие мысли, не повтор. Оставляй.

   Признаки фальстарта (частный случай повтора):
   - Сегмент обрывается или не завершён
   - Следующий сегмент начинает ту же мысль заново
