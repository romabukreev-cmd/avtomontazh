...
# ── Буферы вокруг слов (единый источник правды) ───────────────────────────────

SEG_BUF_START = 0.05   # секунд до первого слова блока
SEG_BUF_END   = 0.15   # секунд после последнего слова блока
MAX_WORD_DUR  = 1.5    # cap на длительность одного слова

# ── Пороги ────────────────────────────────────────────────────────────────────

PAUSE_CUT_SEC = 0.5    # пауза >= этого → разрыв в _split_on_pauses
