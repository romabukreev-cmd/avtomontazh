...
PAUSE_THRESHOLD_SEC = 1.5  # секунды
...
# ─── Настройки PiP (вебка-кружок, Формат 3) ──────────────────────────────────

PIP_WIDTH  = 340   # ширина окошка вебки в пикселях
PIP_HEIGHT = 260   # высота окошка вебки в пикселях
PIP_CORNER_RADIUS = 30      # скруглённость углов (пикселей)
PIP_MARGIN_RIGHT  = 30      # отступ от правого края
PIP_MARGIN_BOTTOM = 30      # отступ от нижнего края
