...
# Пауза: промежуток между словами длиннее порога — граница сегментов
...
# Зазор перед первым словом сегмента (секунды)
# Сегмент начинается не с начала звука, а с первого слова Whisper минус этот зазор.
# 0.1с — достаточно чтобы убрать вдохи/дыхание, но не обрезать начало фразы.
SEGMENT_START_PADDING_SEC = 0.1
